...
let favoriteFoods = ['Italian', 'cheeseburgers', 'chocolate', 'Korean'];
console.log('fav foods:', favoriteFoods);
...
console.log('added and', gemString);
...
console.log('gems and colors', colorfulGems);
